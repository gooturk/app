...
class CameraExampleHome extends ConsumerStatefulWidget {
  /// Default Constructor
  static String get routerName => '/camera';
  const CameraExampleHome({super.key});

  @override
  ConsumerState<CameraExampleHome> createState() {
...
class _CameraExampleHomeState extends ConsumerState<CameraExampleHome>
